...
class Agency extends Table {
  TextColumn get agency_id => text()();

  TextColumn get agency_name => text()();

  TextColumn get agency_url => text()();

  TextColumn get agency_timezone => text()();

  TextColumn get agency_lang => text().nullable()();

  TextColumn get agency_phone => text().nullable()();

  TextColumn get agency_fare_url => text().nullable()();

  TextColumn get agency_email => text().nullable()();

  @override
  Set<Column> get primaryKey => {agency_id};
}

class FeedInfo extends Table {
  TextColumn get feed_publisher_name => text()();

  TextColumn get feed_publisher_url => text()();

  TextColumn get feed_lang => text()();

  TextColumn get default_lang => text().nullable()();

  TextColumn get agency_gtfs_realtime_url => text().nullable()();
}
...
class TransitRoutes extends Table {
  ...
  TextColumn get agency_id =>
      text().nullable().references(Agency, #agency_id)();
